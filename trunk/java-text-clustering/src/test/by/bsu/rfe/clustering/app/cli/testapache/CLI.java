...
public class CLI {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KMeansPlusPlusClusterer<DocumentClusterable> clust = new KMeansPlusPlusClusterer<DocumentClusterable>(
                new Random(), KMeansPlusPlusClusterer.EmptyClusterStrategy.FARTHEST_POINT);
        
        List<org.apache.commons.math.stat.clustering.Cluster<DocumentClusterable>> clusters = clust.cluster(points, numberOfClusters, 100); 
